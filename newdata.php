...
if (isset($_POST['register'])) {
        ...
        $sql = "INSERT INTO trainee( first_name, last_name, age, company) VALUES ('$fname', '$lname', '$age', '$company')";
...
<link rel="stylesheet" type="text/css" href="style.css">
    ...
    <h1 style="margin-top: 30px ; font-size: 30px" >Add data</h1>
...
<a href="deletedata.php"><input type="button" value="Delete  "></a>
 ...
 <form class="form" action="newdata.php" method="post" >
